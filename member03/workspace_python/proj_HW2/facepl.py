...
class VideoWindow(QWidget):
    def __init__(self):
        ...
        self.text_label.setStyleSheet("font-size:16px;color:bule;")
        ...
        self.message_timer.start(2000)#2秒ごとにメッセージを更新
        ...
        if event.timerId()==self.video_timer:
            ...
            if ret:
                ...
                for(top,right,bottom,left),face_encoding in zip(face_locations,face_encodings):
                    ...
                    #顔の周りにボックスを描写
                    cv2.rectangle(frame,(left,top),(right,bottom),(255,200,150),2)
